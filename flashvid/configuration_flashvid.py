...
class FlashVidConfig:
    ...
    prefill_keep_indices: Optional[object] = field(default=None)
    prefill_original_seq_len: Optional[int] = field(default=None)
    prefill_compressed_seq_len: Optional[int] = field(default=None)
